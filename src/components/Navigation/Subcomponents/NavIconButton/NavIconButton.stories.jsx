...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Container Component for Nav Icons. <br> Expects one <code>&lt;NavIcon&gt;</code> and <code>&lt;Text&gt;</code> Element as Child.",
      },
    },
  },
  decorators: [
    (Story) => <NavIconButtonWrapper>{Story()}</NavIconButtonWrapper>,
  ],
  argTypes: {
    active: {
