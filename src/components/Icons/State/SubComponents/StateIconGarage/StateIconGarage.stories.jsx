...
export default {
    ...
    parameters: {
        docs: {
            description: {
                component: 'State Icon Garage Component <br> The SVG is directly manipulated inside the component. <br> Must be wrapped inside <code>&lt;StateIconContainer&gt;</code> Element.',
            },
        },
    },
    argTypes: {
