...
export default {
  ...
  decorators: [(Story) => <DeviceIconContainer>{Story()}</DeviceIconContainer>],
  parameters: {
    docs: {
      description: {
        component:
          "Device Icon Component. <br> The icons are referenced from the <code>./public/deviceicons/*</code>. <br> Icon Values are defined in config file <br> Must be wrapped in <code>&lt;DeviceIconContainer&gt;</code> Element.",
      },
    },
  },
  argTypes: {
